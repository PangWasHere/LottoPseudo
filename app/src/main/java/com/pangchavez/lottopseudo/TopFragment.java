...
public class TopFragment extends Fragment {
    ...
    public void setBalanceAmount(int newBalance){
        ...
        txtBalanceAmount.setText("$" + balanceAmount + ".00");
    }
    ...
    public boolean DeductFromBalance(int amountToPay){
        boolean successfulTransaction = false;

        if(balanceAmount >= amountToPay){
            balanceAmount = balanceAmount - amountToPay;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        final View fragmentView = inflater.inflate(R.layout.fragment_top, container, false);

        txtBalanceAmount = fragmentView.findViewById(R.id.txtBalance);
        btnHomeLogo = fragmentView.findViewById(R.id.imgLogo);
